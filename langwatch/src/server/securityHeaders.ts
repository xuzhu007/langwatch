...
export function buildSecurityHeaders({
  ...
  const disableHttpsHeaders = environment.DISABLE_HTTPS_HEADERS === "true";
  const cspHeader = [
    "default-src 'self'",
    ...
    "style-src 'self' 'unsafe-inline' https://cdn.jsdelivr.net https://cdnjs.cloudflare.com https://*.pendo.io https://client.crisp.chat https://*.google.com https://*.reo.dev https://unpkg.com",
