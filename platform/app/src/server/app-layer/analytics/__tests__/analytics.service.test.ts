...
describe("AnalyticsService", () => {
  ...
  describe("getTopUsedDocuments", () => {
    it("delegates negateFilters to the legacy backend", async () => {
      const { deps, spies } = makeDeps();
      const service = new AnalyticsService(deps);
      ...
      expect(spies.getTopUsedDocuments).toHaveBeenCalledWith(
        "test-project",
        expect.any(Number),
        expect.any(Number),
        {},
  ...
  describe("getFeedbacks", () => {
    it("delegates negateFilters to the legacy backend", async () => {
      ...
      expect(spies.getFeedbacks).toHaveBeenCalledWith(
        "test-project",
        expect.any(Number),
        expect.any(Number),
        {},
